        ...
        <>
            ...
            <div className='relative'>
                ...
                <div className='mt-25 ml-10 w-fit'>
                    <h1 className='text-[70px] font-black font-pop italic'>Come on in! <span className='text-2xl'>Sign up here.</span> </h1>
                    <div className='flex ml-2'>
                        <h1 className='text-[15px] font-space italic'>Already have an account?</h1>
                        <Link className='ml-2 hover:underline font-alef text-darker-blue' to={'/login'}>Login</Link>
                    </div>
                </div>
